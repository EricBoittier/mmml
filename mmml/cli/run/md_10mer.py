#!/usr/bin/env python3
"""CLI wrapper for md_10mer simulation scripts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run predefined md_10mer setups (free-space NVE/NVT, periodic NVE/NVT, periodic NPT). "
            "This command wraps scripts/md_10mer_mmml_pbc_suite.py and "
            "scripts/md_10mer_mmml_pbc_suite_jaxmd.py."
        )
    )
    parser.add_argument(
        "--setup",
    ...
    parser.add_argument("--n-molecules", type=int, default=10, help="Number of molecules.")
