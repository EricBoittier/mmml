#!/usr/bin/env python3
"""
Joint PhysNet+DCMNet Training CLI Tool

This CLI tool trains PhysNet with either DCMNet (equivariant) or a non-equivariant 
...
def main():
    ...
    parser.add_argument('--charge-reg-weight', type=float, default=1.0,
                       help='L2 regularization on DCMNet charge magnitudes to prevent blow-up (default: 1.0)')
    ...
    try:
        final_params = train_model(
            ...
            charge_reg_w=args.charge_reg_weight,
            n_dcm=args.n_dcm,
