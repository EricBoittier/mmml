...
COMMAND_REGISTRY: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        status="deprecated",
        replacement="physnet-evaluate or ef-evaluate",
    ),
    ...
    CommandSpec("physnet-train", "mmml.cli.make.make_training", "Train PhysNetJAX EF from NPZ"),
    ...
    CommandSpec("ef-train", "mmml.cli.misc.ef_train", "Train EF equivariant model", parser_module="mmml.models.EF.training"),
    CommandSpec("ef-evaluate", "mmml.cli.misc.ef_evaluate", "Evaluate EF model", parser_module="mmml.models.EF.evaluate"),
    CommandSpec("ef-md", "mmml.cli.misc.ef_md", "MD with trained EF model"),
