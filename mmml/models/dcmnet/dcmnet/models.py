...
------
DCM1 : DCMNetCharges
    Model with 1 distributed charge site per atom
DCM2 : DCMNetCharges
    Model with 2 distributed charge sites per atom
DCM3 : DCMNetCharges
    Model with 3 distributed charge sites per atom
DCM4 : DCMNetCharges
