...
params = CharmmParameterSet('/pchem-data/meuwly/boittier/home/charmm/toppar/top_all36_cgenff.rtf',
...
simulation.reporters.append(DCDReporter('trajectory.dcd', 1000))  # Save trajectory every 1000 steps
