...
def run_md(useomm=False,useblade=False,nequil=1000,nsteps=1000,nsavc=100,leap=True,lang=True):
    ...
    my_dyn = pycharmm.DynamicsScript(leap=False, cpt=True, lang=False, start=True,
                                     nstep=nequil, timest=0.0005,
                                     firstt=100.0, finalt=298.0, tbath=298.0,
                                     tstruc=298.0,
                                     teminc=1.0, twindh=1.0, twindl=1.0,
                                     iunwri=res_file.file_unit,
                                     iunlam=lam_file.file_unit,
                                     inbfrq=-1, imgfrq=-1,
                                     iasors=0, iasvel=1, ichecw=0, iscale=0,
                                     iscvel=0,echeck=-1, nsavc=0, nsavv=0, nsavl=0, ntrfrq=10,
                                     isvfrq=nsavc,
