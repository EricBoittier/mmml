...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "build_metatomic_mlpot_model": (".metatomic_mlpot", "build_metatomic_mlpot_model"),
    "MetatomicMlpotModel": (".metatomic_mlpot", "MetatomicMlpotModel"),
    ...
    "select_by_resname": (".setup", "select_by_resname"),
    "select_by_resnames": (".setup", "select_by_resnames"),
    "resolve_mlpot_selection_from_args": (".setup", "resolve_mlpot_selection_from_args"),
