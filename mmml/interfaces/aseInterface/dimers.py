...
def get_dimer_calculator(
    ...
    def calc_dimer_energy_forces(R, Z, ase_atoms_dimer, ase_atoms_monomer):
        ...
        val_mm_s = switch_MM(X, chm_d_E)  # MM switching value
        val_ml_s = switch_ML(X, final_energy)  # ML switching value
        grad_mm_s = switch_MM_grad(X, chm_d_E)  # MM switching gradient
