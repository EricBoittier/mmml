...
- [jax-mm-spoof vs native CHARMM](jax-mm-spoof-charmm-parity.md) — DCM/ACO bonded ETERM parity report
- [Manuscript: hybrid ML/MM condensed phase](manuscripts/condensed-phase-hybrid-mlmm/README.md) — outline, Methods/Results drafts, Snakemake map
...
- [Batched umbrella sampling](umbrella.md) — pure-ML distance umbrella NVT + MBAR
