...
% Title page
\title{The Journey to Transferable, Accurate, Anisotropic Molecular Machine Learning}
\subtitle{The DCM Approach}
...
% \begin{frame}{Hero's Journey Archetypes}
% \begin{itemize}
%     \item Hero — willing to sacrifice for others (Me)
%     \item Mentor — guides, protects, and equips (Markus)
%     \item Threshold Guardian — tests resolve (First Paper)
%     \item Herald — announces the challenge (f-MDCM forces)
%     \item Shapeshifter — shifts perspective
%     \item Shadow — embodies the opposing force
%     \item Allies — travel alongside the hero (Mike, Luis, Silvan)
%     \item Trickster — sparks change through mischief
% \end{itemize}
% \end{frame}

\section{Ordinary World: Introduction}

\begin{frame}{Ordinary World}
\begin{figure}
\includegraphics[width=0.35\textwidth]{take2/alphafold.png}
\includegraphics[width=0.35\textwidth]{take2/maps.png}
\includegraphics[width=0.35\textwidth]{take2/go.png}
\caption{AlphaFold, Google Maps, AlphaGo - Graph Neural Networks}
\end{figure}
\end{frame}

\begin{frame}{Call to Adventure}
    \includegraphics[width=0.5\textwidth]{uq.png}
\begin{itemize}
    \item Markus's 2019 talk on Hemoglobin sparks curiosity
    \item Mentions of a new, graph neural network model called PhysNet
    \item The rest is history...
    \end{itemize}
\end{frame}

\begin{frame}{Refusal of the Call}
In atomistic machine learning, two paradigms emerge:
\begin{itemize}
    \item \textbf{Chemical Space} (combinatorial explosion of possible molecules)
    \item \textbf{Conformational space} (many possible conformations for a given molecule)
\end{itemize}
\includegraphics[width=0.25\textwidth]{take2/figs3/FIGURE10.png}
% \includegraphics[width=0.25\textwidth]{take2/figs3/FIG10.png}
\end{frame}

\section{Crossing the First Threshold: fMDCM}

    \begin{frame}{Crossing the First Threshold}{Fluctuating MDCM (f-MDCM)}
    \begin{figure}
        \includegraphics[width=0.75\textwidth]{take2/figs2/toc.png}
    \end{figure}
\end{frame}

\section{Tests, Allies, and Enemies}

\begin{frame}{Tests, Allies, and Enemies}
\begin{figure}
    \includegraphics[width=0.75\textwidth]{take2/figs2/FIG1.png}
\caption{Early ideas: f-MDCM}
\end{figure}
\end{frame}

\begin{frame}{Tests, Allies, and Enemies}
    \begin{figure}
        \includegraphics[width=0.75\textwidth]{take2/figs2/FIG3.png}
    \caption{Early ideas: f-MDCM}
    \end{figure}
    \end{frame}
...
\begin{frame}{Tests, Allies, and Enemies}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{take2/figs2/SIFIG1.png}
    \caption{Energy conservation and tests}
    \end{figure}
    \end{frame}

\section{Approach to the Innermost Cave: kMDCM}

    \begin{frame}{Approach to the Innermost Cave}
        \begin{figure}
            \includegraphics[width=0.7\textwidth]{take2/figs/toc.png}
        \caption{The kMDCM approach}
        \end{figure}
    \end{frame}

\begin{frame}{Approach to the Innermost Cave}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{take2/figs/kmdcm-fig1.png}
    \caption{The kMDCM approach (continued)}
    \end{figure}
\end{frame}

\begin{frame}{Approach to the Innermost Cave}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{take2/figs/kMDCM-methanol.png}
    \caption{The kMDCM approach (continued)}
    \end{figure}
\end{frame}
...
\begin{frame}{Approach to the Innermost Cave}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{take2/figs/dipoles-4.pdf}
    \caption{The kMDCM approach (continued)}
    \end{figure}
\end{frame}

\section{The Ordeal: DCM-Net}

\begin{frame}{The Ordeal}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{take2/figs3/FIGURE1.png}
    \caption{DCM-Net}
    \end{figure}
    \end{frame}
    ...
    \begin{frame}{The Ordeal}
        \begin{figure}
            \includegraphics[width=0.53\textwidth]{take2/figs3/FIGURE3.png}
        \caption{DCM-Net}
        \end{figure}
        \end{frame}
        ...
        \begin{frame}{The Ordeal}
            \begin{figure}
                \includegraphics[width=0.7\textwidth]{take2/figs3/FIGURE7.png}
            \caption{DCM-Net}
            \end{figure}
            \end{frame}

\begin{frame}{The Ordeal}{Training}
\begin{figure}
    \includegraphics[width=0.85\textwidth]{take2/figs3/rect9.png}
\caption{Equivariance test: Training}
\end{figure}
\end{frame}

\begin{frame}{The Ordeal}{Validation}
    \begin{figure}
        \includegraphics[width=0.85\textwidth]{take2/figs3/rect93.png}
    \caption{Equivariance test: Validation}
    \end{figure}
    \end{frame}


\begin{frame}{The Ordeal}{Test}
    \begin{figure}
        \includegraphics[width=1.0\textwidth]{take2/figs3/rect92.png}
    \caption{Equivariance test: Test}
    \end{figure}
    \end{frame}

\section{Reward: Applications}

\begin{frame}{Reward}{Rapid, Accurate, Anisotropic Molecular Machine Learning}

\begin{figure}
    \includegraphics[width=0.7\textwidth]{take2/figs3/FIGURE5.png}
\end{figure}
% \begin{itemize}
%     \item PhysNet + DCMNet delivers the breakthrough
%     % \item Proof that the effort paid off
% \end{itemize}
\end{frame}


\section{The Road Back: Conclusion}

\begin{frame}{The Road Back}
% \begin{itemize}
%     \item Bringing insights back to daily practice
%     \item Translating results into workflows
% \end{itemize}
