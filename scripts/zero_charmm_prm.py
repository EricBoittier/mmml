...
def zero_prm_line(line: str, section: str | None) -> str:
...
def zero_prm_text(text: str) -> str:
...
def zero_prm_file(src: Path, dst: Path) -> None:
    ...
    zeroed = header + zero_prm_text(text)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.source.is_file():
        ...
        return 1
    zero_prm_file(args.source, args.destination)
