...
#SBATCH --output=artifacts/lj_scales/dense_dt_campaign/logs/ddc-eval-on5-%j.out
#SBATCH --error=artifacts/lj_scales/dense_dt_campaign/logs/ddc-eval-on5-%j.err
set -euo pipefail
...
uv run python scripts/slurm/dense_dt_campaign/eval_lever2_on5_ft.py
echo "done $(date -Is)"
