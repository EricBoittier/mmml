...
echo "  epochs=${DDC_ON5SW_EPOCHS:-20} lr=${DDC_ON5SW_LR:-0.0001} sw_steps=${DDC_ON5SW_STEPS:-16}"
...
EXPORT_LIST+=",DDC_ON5SW_STEPS=${DDC_ON5SW_STEPS:-16},DDC_ON5SW_SW_BATCH=${DDC_ON5SW_SW_BATCH:-32}"
