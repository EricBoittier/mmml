...
echo "  epochs=${DDC_ON5SW_EPOCHS:-20} lr=${DDC_ON5SW_LR:-0.0001} sw_steps=${DDC_ON5SW_STEPS:-64} scale=${DDC_ON5SW_LOSS_SCALE:-50}"
...
EXPORT_LIST+=",DDC_ON5SW_STEPS=${DDC_ON5SW_STEPS:-64},DDC_ON5SW_EVERY=${DDC_ON5SW_EVERY:-20}"
EXPORT_LIST+=",DDC_ON5SW_SW_BATCH=${DDC_ON5SW_SW_BATCH:-32},DDC_ON5SW_LOSS_SCALE=${DDC_ON5SW_LOSS_SCALE:-50.0}"
