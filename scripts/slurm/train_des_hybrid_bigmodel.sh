...
#SBATCH --mem=64G
#SBATCH --array=0-2
#SBATCH --output=artifacts/lj_scales_des_bigmodel_s/logs/slurm-%A_%a.out
#SBATCH --error=artifacts/lj_scales_des_bigmodel_s/logs/slurm-%A_%a.err
...
RUN_ROOT="$REPO/artifacts/lj_scales_des_bigmodel_s/ew_${EW}"
...
DATA="${LJ_DATA:-$REPO/artifacts/lj_scales_des/des_dimers_cgenff_top50_min15_eref_sp.npz}"
