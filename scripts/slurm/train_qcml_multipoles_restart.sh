...
echo "HUBER_DELTA=$HUBER_DELTA TARGET_SCALE_MODE=$TARGET_SCALE_MODE"
echo "DEGREE_WEIGHTS=$DEGREE_WEIGHTS"
echo "OUTLIER_QUANTILE=$OUTLIER_QUANTILE OUTLIER_DEGREE_MODE=$OUTLIER_DEGREE_MODE"
