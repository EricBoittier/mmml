...
Pass/fail (heuristic):
  ...
  - Worst monomer COM displacement vs t=0 not more than ``--outlier-factor`` × median
...
def analyze_com(
    ...
    *,
    ...
    """Compute COM trajectories and displacement metrics."""
...
def main() -> int:
    ...
    stats = analyze_com(pos, offsets, outlier_factor=args.outlier_factor)
