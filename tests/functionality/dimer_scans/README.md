...
([`workflows/dcm3_nve_cutoff_sweep`](../../workflows/dcm3_nve_cutoff_sweep/)) and the
MEOH distance scan ([`scripts/scan_meoh_dimer_distance.py`](../../scripts/scan_meoh_dimer_distance.py)),
...
- [Long-range solver tutorial](../../docs/long-range-solver-tutorial.md)
- [MLpot switching](../../docs/mlpot-settings.md)
- [`tests/functionality/long_range/`](../long_range/) — backend validation without MD
