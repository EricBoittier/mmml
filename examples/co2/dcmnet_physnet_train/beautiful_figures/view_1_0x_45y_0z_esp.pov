...
// no cell vertices
atom(<  0.00,   0.00,  -0.83>, 0.01, rgb <0.56, 0.56, 0.56>, 0.0, jmol) // #0
atom(<  0.83,   0.00,   0.00>, 0.01, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #1
atom(< -0.83,   0.00,  -1.65>, 0.01, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #2
