...
// no cell vertices
atom(<  0.00,   0.00,  -0.58>, 0.40, rgb <0.56, 0.56, 0.56>, 0.0, jmol) // #0
atom(<  1.00,  -0.17,   0.00>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #1
atom(< -1.00,   0.17,  -1.17>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #2
