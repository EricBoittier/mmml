...
cylinder {<  0.00,   0.00,  -0.58>, <  0.50,  -0.09,  -0.29>, Rbond texture{pigment {color rgb <0.56, 0.56, 0.56> transmit 0.900} finish{jmol}}}
cylinder {<  1.00,  -0.17,   0.00>, <  0.50,  -0.09,  -0.29>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.900} finish{jmol}}}
cylinder {<  0.00,   0.00,  -0.58>, < -0.50,   0.09,  -0.88>, Rbond texture{pigment {color rgb <0.56, 0.56, 0.56> transmit 0.900} finish{jmol}}}
cylinder {< -1.00,   0.17,  -1.17>, < -0.50,   0.09,  -0.88>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.900} finish{jmol}}}
// no constraints
