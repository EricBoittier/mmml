...
sphere {
  ...
  texture {
    pigment { rgbf <0.954, 0.962, 0.966, 0.50> }
...
sphere {
  <0.0000, 0.0000, 0.0000>, 0.0600
  texture {
    pigment { rgbf <0.972, 0.954, 0.943, 0.50> }
    finish { charge_finish }
  }
}
...
sphere {
  ...
  texture {
    pigment { rgbf <0.723, 0.849, 0.913, 0.50> }
    finish { charge_finish }
  }
}
...
sphere {
  ...
  texture {
    pigment { rgbf <0.174, 0.459, 0.705, 0.50> }
    finish { charge_finish }
  }
}
...
sphere {
  ...
  texture {
    pigment { rgbf <0.890, 0.931, 0.954, 0.50> }
    finish { charge_finish }
  }
}
