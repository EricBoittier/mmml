...
atom(<  0.00,  -1.17,   0.00>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #1
atom(<  0.00,   1.17,  -0.00>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #2
cylinder {<  0.00,   0.00,  -0.00>, <  0.00,  -0.58,  -0.00>, Rbond texture{pigment {color rgb <0.56, 0.56, 0.56> transmit 0.0} finish{jmol}}}
cylinder {<  0.00,  -1.17,   0.00>, <  0.00,  -0.58,  -0.00>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{jmol}}}
cylinder {<  0.00,   0.00,  -0.00>, <  0.00,   0.58,  -0.00>, Rbond texture{pigment {color rgb <0.56, 0.56, 0.56> transmit 0.0} finish{jmol}}}
cylinder {<  0.00,   1.17,  -0.00>, <  0.00,   0.58,  -0.00>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{jmol}}}
// no constraints
