...
train_model(
    ...
    num_epochs=1000,
    restart="/home/ericb/mmml/mmml/physnetjax/ckpts/progressive-stage2-9a3b53e8-80c5-4069-a1a9-e8a89899b016/epoch-289", #nb_dir / "ACO-b4f39bb9-8ca7-485e-bf51-2e5236e51b56",
    batch_size=248,
    num_atoms=natoms,
    batch_method="default",
    data_keys=("R", "Z", "F", "E", "N", "D", "dst_idx", "src_idx", "batch_segments"),
