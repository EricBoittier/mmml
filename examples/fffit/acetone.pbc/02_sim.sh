...
export ML_CUTOFF="0.1"
export MM_SWITCH_ON="5.0"
export MM_CUTOFF="5.0"
export INCLUDE_MM="true"          # set to "true" or leave empty
export SKIP_ML_DIMERS="false"     # set to "true" or leave empty
export DEBUG="false"
export TEMPERATURE="200.0"
export TIMESTEP="0.3" # 0.1 ps (i.e. 100 fs)
