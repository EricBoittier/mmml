...
camera {orthographic
  right -1.71*x up 2.58*y
  direction 1.00*z
  location <0,0,18.75> look_at <0,0,0>}
...
// no cell vertices
atom(<  0.00,   0.00,  -0.72>, 0.40, rgb <0.56, 0.56, 0.56>, 0.0, jmol) // #0
atom(<  0.41,  -0.83,   0.00>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #1
atom(< -0.41,   0.83,  -1.43>, 0.40, rgb <1.00, 0.05, 0.05>, 0.0, jmol) // #2
