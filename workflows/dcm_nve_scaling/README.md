...
- `dynamics_overlap_check_interval: 8000` (single NVE chunk at 2 ps / 0.25 fs; no scratch restart handoff)
- `no_echeck: true` for the 2 ps NVE leg (in-run echeck stops ML USER clusters within ~1k steps; `run_job.py` still validates DCD length)
